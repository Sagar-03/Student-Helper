...
export default function Dashboard() {
  ...
  const [userType, setUserType] = useState("day-Scholar"); // Default to day-Scholar
  ...
  const hostellerCards = [
    {
      ...
      onClick: () => navigate("/hosteller/night-market"),
    },
    {
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fillRule="evenodd"
            d="M6 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm0 3a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 5a1 1 0 100 2h6a1 1 0 100-2H7z"
            clipRule="evenodd"
          />
        </svg>
      ),
  ...
  // Render card component - different styles for hosteller and day-Scholar
        ...
        <div className="flex flex-col items-center justify-center flex-1 py-8 px-6">
          ...
          <div className="bg-white bg-opacity-80 backdrop-filter backdrop-blur-lg p-8 rounded-2xl shadow-xl z-10 w-full max-w-6xl">
            ...
            <p className="text-gray-600 text-center mb-8">
              Your complete student resource center
            </p>
            ...
            <div className="flex justify-center mb-10">
              <div className="flex gap-4 w-full max-w-md">
                ...
                >
                  ...
                  <span className="font-medium">Day-Scholar</span>
                  {userType === "day-Scholar" && (
            ...
            >
              ...
              <ul
                className={`text-sm ml-5 list-disc ${
                  userType === "hosteller" ? "text-blue-700" : "text-teal-700"
                }`}
              >
                ...
                {userType === "hosteller" && (
                  <li>
                    Report any hostel issues through the Hostel Complaints
                    section
                  </li>
                )}
                {userType === "day-Scholar" && (
                  <li>
                    Find affordable accommodations near campus in the Nearest PG
                    section
                  </li>
                )}
              </ul>

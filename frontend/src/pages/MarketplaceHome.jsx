  ...
  const features = [
    {
      ...
      description: "Access high-quality notes, textbooks, and study guides from fellow students",
      icon: (
    ...
    },
    {
      ...
      description: "Make extra money by selling your notes, projects and academic resources",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Discover resources from students who've taken the same courses",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Find affordable academic resources that fit your student budget",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  const testimonials = [
    {
      ...
      quote: "Found last semester's project examples that helped me ace my final assignment!",
      avatar: "A"
    },
    {
      name: "Priya M.",
      role: "Biology Major",
      quote: "Sold my detailed anatomy notes and made enough to cover my textbooks this semester.",
      avatar: "P"
    },
    {
      name: "Sam T.",
      role: "Computer Science Student",
      quote: "The marketplace has been a game-changer for finding affordable study materials.",
      avatar: "S"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 text-center relative z-10">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Buy and sell academic resources directly from fellow students. 
            Save money, help others, and find exactly what you need for your courses.
          </p>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why Use Student Marketplace?</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100 hover:border-blue-100 transform hover:-translate-y-1 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Sign up with your student credentials to get started</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Look for resources or upload your own items for sale</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Communicate with buyers/sellers and complete your transaction</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gradient-to-br from-indigo-50 to-blue-50 p-1 rounded-xl">
                <div className="bg-white h-full p-6 rounded-lg shadow-sm flex flex-col">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of students already saving money and earning extra cash with our student marketplace</p>
